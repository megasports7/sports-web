...
export default function DistrictSecretaryPlayersPage() {
  return (
    <PortalSectionPage kind="district_secretary" title="Players" bare>
      {({ perms, players, loading, scope, error }) => {
        ...
        return <PlayersSection players={players} scopeLabel={scope?.label ?? 'district'} kind="district_secretary" />;
      }}
    </PortalSectionPage>
  );
}
