    ...
    <nav className="nav">
      ...
      <style jsx>{`
        ...
        :global(.tab.active) {
          ...
          color: #fff;
          box-shadow: 0 4px 10px -4px color-mix(in srgb, var(--color-accent-blue) 50%, transparent);
        }
        .signout-desktop {
          margin-left: auto;
          font-size: 13.5px;
        ...
        /* Below this, the tab row genuinely can't fit six tabs plus the
           brand and sign-out without wrapping into a messy multi-row nav --
           collapse into a hamburger + dropdown instead of letting it wrap. */
