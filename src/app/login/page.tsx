...
const ROLE_COLOR_VAR: Record<UserRole, string> = {
...
/** One icon per role, tied to what that role actually does in this app
 *  (organizer runs events, referee times/records matches, admin
 *  administers, associate manages an attendance roster) rather than
 *  decorative glyphs. `currentColor` via presentation attributes, so it
 *  follows whatever `color` the parent (chip or badge) sets -- no CSS
 *  class needed, which also sidesteps styled-jsx's scoping. */
